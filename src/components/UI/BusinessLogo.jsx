  ...
  return (
    <div
      style={{
        ...
        alignSelf: align,
        borderRadius: radius,
        // The shadow lives on this outer box, deliberately NOT clipped by
        // overflow:hidden: combining box-shadow with overflow:hidden on the
        // same rounded box produces a faint seam/border artifact on some
        // renderers. The inner box below (which does have overflow:hidden)
        // handles clipping the image to the rounded corners instead.
