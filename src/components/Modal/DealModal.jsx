    ...
    <>
      ...
      >
        ...
        <div className="ssc-scroll overflow-y-auto" style={{ maxHeight: '55vh', padding: '0 20px' }}>
          ...
          >
            <div
              ...
              style={{ fontFamily: 'Sora, sans-serif', fontSize: displayValue ? '15px' : '17px', color: isExhausted ? '#94a3b8' : '#0f172a' }}
            >
              {deal.deal.title}
            </div>
            {displayValue && (
        ...
        <div style={{ padding: '16px 20px 20px', borderTop: '1px solid #f1f5f9' }}>
          ...
          <button
            onClick={onClose}
            className="w-full font-semibold rounded-xl transition-colors text-sm py-3"
            style={{
