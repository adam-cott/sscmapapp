      ...
      >
        ...
        <div className="ssc-scroll overflow-y-auto" style={{ maxHeight: '55vh', padding: '0 20px' }}>
          ...
          <div className="space-y-3 mb-5">
            {[
              deal.address && { icon: <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>, text: deal.address },
