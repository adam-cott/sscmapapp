    ...
    <div style={{ display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0, overflow: 'hidden', backgroundColor: '#f0f4f8' }}>
      ...
      <div style={{ flexShrink: 0, backgroundColor: '#ffffff', borderBottom: '1px solid #e8edf3', boxShadow: '0 1px 4px rgba(0,0,0,0.05)' }}>
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: '10px 16px 6px', gap: '10px' }}>
          <div style={{ fontFamily: 'Sora, sans-serif', fontWeight: 700, fontSize: '16px', color: 'var(--ssc-blue)', letterSpacing: '-0.01em', whiteSpace: 'nowrap', flexShrink: 0 }}>
            Starving Student Card
          </div>
          <div style={{ flex: 1, minWidth: 0, fontSize: '14px', fontWeight: 500, color: '#64748b', textAlign: 'right', lineHeight: 1.3 }}>
